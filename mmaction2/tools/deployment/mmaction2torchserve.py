...
def mmaction2torchserve(
    ...
    Args:
        ...
        label_file (str | None): A txt file which contains the action category
            names. Optional. If not provided, inference output will not include
            class names.
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='A txt file which contains the action category names. Optional.')
    parser.add_argument(
        '--model-version',
        type=str,
        default='1.0',
